...
my_radex: configure.o main.o my_radex.o opkda1.o opkdmain.o statistic_equilibrium.o sub_global_variables.o sub_trivials.o nleq1.o linalg_nleq1.o wnorm.o zibconst.o zibmon.o zibsec.o 
	$(cpl) $(lflags) -o my_radex configure.o main.o my_radex.o opkda1.o opkdmain.o statistic_equilibrium.o sub_global_variables.o sub_trivials.o nleq1.o linalg_nleq1.o wnorm.o zibconst.o zibmon.o zibsec.o 

wrapper_my_radex.so: wrapper_for_python.f90 my_radex.o opkda1.o opkdmain.o statistic_equilibrium.o sub_global_variables.o sub_trivials.o nleq1.o linalg_nleq1.o wnorm.o zibconst.o zibmon.o zibsec.o 
	f2py -c -m wrapper_my_radex wrapper_for_python.f90 -L my_radex.o opkda1.o opkdmain.o statistic_equilibrium.o sub_global_variables.o sub_trivials.o nleq1.o linalg_nleq1.o wnorm.o zibconst.o zibmon.o zibsec.o 
