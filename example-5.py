...
if __name__ == '__main__':
    ...
    solvers = [
        manager.create_solver('12CO', dir_transition_rates='./', filename_molecule='12C16O_H2.dat', solve_method='ODE', f_occupation_init_method='Boltzmann'),
        manager.create_solver('CI', dir_transition_rates='./', filename_molecule='catom.dat', solve_method='ODE', f_occupation_init_method='Boltzmann')
    ]
